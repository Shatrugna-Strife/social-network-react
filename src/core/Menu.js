...
const Menu =(props) =>(
    <div>
        <ul className="nav nav-tabs">
            ...
            <li className="nav-item"><Link className={activeLink(props, "/users")?"active nav-link":"nav-link"} to="/users">Users</Link></li>
            {
                !isAuthenticated()&&(<>
            ...
            }
            {
                isAuthenticated()&&(
                <>
                    <li className="nav-item"><a href="/" className="nav-link" style={{cursor:"pointer"}} onClick={()=>{return signout(()=>{props.history.push("/");})}}>Signout</a></li>
